...
%                                                                         %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %  
run('D:\InSilicoTEM-2.0.0\DIPimage 2.9\dipstart.m')
clc;
close all;
clear;
...
tic
 ...
 rpdb = pdbread('./PDBs/1kd1.pdb'); % Select PDB file to read
toc
disp(' ')               
        ...
        for d = 1:length(dose)
            for mb = 1 : length (mb_series)    
                try
                    ...
                    ImageOut = out.noiseless_series; %.noiseless_series
                    ImageOut2 = out.series;
                    ...
                    WriteMRC(double(ImageOut),0.5,[dir_clean filesep char(s1)]);
                    WriteMRC(double(ImageOut2),0.5,[dir_noise filesep char(s1)]);
                    disp(' ')
