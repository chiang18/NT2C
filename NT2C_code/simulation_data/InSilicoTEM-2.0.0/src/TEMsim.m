...
params.spec.pdbin        = '1kd1' ;               % Required if params.spec.source = 'map' or 'pdb' ( 2GTL, 2WRJ, 1SA0, 1RYP or any other pdb entree)
...
params.cam.type              = 'K2'; % Options: 'custom', 'Eagle4k', 'US4000', 'US1000GIF', 'FalconI', 'FalconIII_Linear','FalconIII_EC', 'K2' , 'perfect' (64% at Nq -counting mode), 'ideal' (100% at Nq)
...
params.disp.generateWhat   = 'imNoiseless'; % Options: 'im', 'exitw', 'imNoiseless'
...
[InputVol, PosOrient] = generateFullVolume(PartPot,params2,circl,mindist);   %條overlapp 會錯
