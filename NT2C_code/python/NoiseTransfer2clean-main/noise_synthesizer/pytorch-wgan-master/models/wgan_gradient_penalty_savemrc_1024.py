...
class WGAN_GP(object):
    def __init__(self, args):
        ...
        # Set the logger
        self.logger = Logger('/content/gdrive/MyDrive/NT2C/10077/Wgan/9000data/logs') #./logs
    ...
    def evaluate2(self, num, D_model_path, G_model_path,output):
        n=num
        output_zip = os.path.join(output, 'gan_256.zip')
        with zipfile.ZipFile(output_zip, 'w', zipfile.ZIP_DEFLATED) as zipf:
          for b in range(int(n/1000)):
            batch_size=1000
            self.load_model(D_model_path, G_model_path)
            ...
            for i in range(batch_size):
              ##noise_out_0=mrcfile.new('/content/gdrive/MyDrive/NT2C/10077/SIM_EM77_5lzf_data/gan_noise_256/img_generatori_iter_{}_{}.mrc'.format(str(b),str(i)),overwrite=True)           
              noise_arr_0=samples.data.cpu().numpy()[i]
              #print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
              mrc_out = mrcfile.new('img_generatori_iter_{}_{}.mrc'.format(str(b),str(i)), overwrite=True)
    ...
    def save_model(self):
        torch.save(self.G.state_dict(), '/content/gdrive/MyDrive/NT2C/10077/Wgan/generator.pkl')
        torch.save(self.D.state_dict(), '/content/gdrive/MyDrive/NT2C/10077/Wgan/discriminator.pkl')
