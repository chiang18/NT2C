...
class WGAN_GP(object):
    ...
    def evaluate2(self, num, D_model_path, G_model_path):
        n=num
        for b in range(int(n/1000)):
          ...
          for i in range(batch_size):
            noise_out_0=mrcfile.new('/content/gdrive/MyDrive/meeting/暑假/NT2C/mrc檔/2wrj/mindist210-2500lap/gan_noise/img_generatori_iter_{}_{}.mrc'.format(str(b),str(i)),overwrite=True)           
