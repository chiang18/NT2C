...
def parse_args():
    ...
    parser.add_argument('--noise_num', type=int, default=10, help='The number of iterations for generator in WGAN model.')
    parser.add_argument('--o', required=True, help='path to dataset')
